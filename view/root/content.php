...
<!--
						<div class="section_block_box_wave">
								<img width="640" height="400" src="<?php echo HTTP;?>assets/img/common/wave_top_8.png" title="" alt="">
						<div class="section_block_box_wave_inner">
	
						</div>
								<img width="640" height="400" src="<?php echo HTTP;?>assets/img/common/wave_bottom_8.png" title="" alt="">
						</div>
-->
